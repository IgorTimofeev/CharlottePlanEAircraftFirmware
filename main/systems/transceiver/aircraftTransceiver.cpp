...
namespace pizda {
	...
	bool AircraftTransceiver::receiveRemoteSystemPacket(BitStream& stream, const uint8_t payloadLength) {
		...
		const auto readPID = [&stream, payloadLength](PIDCoefficients& coefficients) {
			...
			Aircraft::getInstance().settings.autopilot.scheduleWrite();
		...
		switch (type) {
			...
			case RemoteSystemPacketType::magneticDeclination: {
				...
				ac.settings.adirs.magneticDeclinationDeg = stream.readInt16(RemoteSystemPacket::magneticDeclinationLengthBits);
				ac.settings.adirs.scheduleWrite();
			...
			case RemoteSystemPacketType::communicationSettings: {
				...
				_tmpCommunicationSettings.frequencyHz = stream.readUint16(RemoteSystemCommunicationSettingsPacket::RFFrequencyLengthBits) * 1'000'000;
				_tmpCommunicationSettings.bandwidth = static_cast<SX1262::LoRaBandwidth>(stream.readUint8(RemoteSystemCommunicationSettingsPacket::bandwidthLengthBits));
				_tmpCommunicationSettings.spreadingFactor = stream.readUint8(RemoteSystemCommunicationSettingsPacket::spreadingFactorLengthBits);
				_tmpCommunicationSettings.codingRate = static_cast<SX1262::LoRaCodingRate>(stream.readUint8(RemoteSystemCommunicationSettingsPacket::codingRateLengthBits));
				_tmpCommunicationSettings.syncWord = stream.readUint8(RemoteSystemCommunicationSettingsPacket::syncWordLengthBits);
				_tmpCommunicationSettings.preambleLength = stream.readUint16(RemoteSystemCommunicationSettingsPacket::preambleLengthLengthBits);

				_tmpCommunicationSettings.currentLimitMA = stream.readInt8(RemoteSystemCommunicationSettingsPacket::currentLimitMALengthBits);
				_tmpCommunicationSettings.powerDBm = stream.readInt8(RemoteSystemCommunicationSettingsPacket::powerDBmLengthBits);
			...
			case RemoteSystemPacketType::autopilotHeading: {
				...
				ac.fbw.setSelectedHeadingDeg(stream.readUint16(RemoteSystemPacket::autopilotHeadingLengthBits));
			...
			case RemoteSystemPacketType::autopilotMaxAileronsPercent: {
				...
				ac.settings.autopilot.maxAileronsPercent = stream.readUint8(RemoteSystemPacket::autopilotPercentLengthBits);
				ac.settings.autopilot.scheduleWrite();
			...
			case RemoteSystemPacketType::autopilotMaxElevatorPercent: {
				...
				ac.settings.autopilot.maxElevatorPercent = stream.readUint8(RemoteSystemPacket::autopilotPercentLengthBits);
				ac.settings.autopilot.scheduleWrite();
			...
			case RemoteSystemPacketType::autopilotSpeed: {
				...
				ac.fbw.setSelectedSpeedMps(static_cast<float>(RemoteSystemPacket::autopilotSpeedMaxMPS) * speedFactor);
			...
			case RemoteSystemPacketType::autopilotMinThrottlePercent: {
				...
				ac.settings.autopilot.minThrottlePercent = stream.readUint8(RemoteSystemPacket::autopilotPercentLengthBits);
				ac.settings.autopilot.scheduleWrite();
			...
			case RemoteSystemPacketType::autopilotMaxThrottlePercent: {
				...
				ac.settings.autopilot.maxThrottlePercent = stream.readUint8(RemoteSystemPacket::autopilotPercentLengthBits);
				ac.settings.autopilot.scheduleWrite();
